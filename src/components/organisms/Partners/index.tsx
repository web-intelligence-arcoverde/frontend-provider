      ...
      {inView === true ? (
        <TextContainer>
          ...
          <p>
            ...
            vantagens para seus participantes. Em primeiro lugar, assumimos que
            esse projeto é uma ótima maneira de compartilhar experiências
